		...
		$html	.= '
								   		<form method="post" action="">
								   			<div style="margin-top: 10px; margin-left:2px;">
									   			<label>
													<input type="checkbox" name="accept" value="1" style="margin:0px; padding:0px; border:0px solid; line-height:1; margin-right:8px;" />I accept the '.SITE_TITLE.' <a href="license.txt" target="_blank">License&nbsp;terms&nbsp;and&nbsp;limitations</a>.
												</label>
											</div>
